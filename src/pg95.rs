...
pub struct CustomScanMethods {
    ...
    pub CreateCustomScanState: ::std::option::Option<unsafe extern "C" fn(cscan:
                                                                              *mut CustomScan)
                                                         -> *mut Node>,
    pub TextOutCustomScan: ::std::option::Option<unsafe extern "C" fn(str:
                                                                          StringInfo,
                                                                      node:
                                                                          *const CustomScan)>,
}
impl ::std::default::Default for CustomScanMethods {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct CustomExecMethods {
    pub CustomName: *const ::std::os::raw::c_char,
    pub BeginCustomScan: ::std::option::Option<unsafe extern "C" fn(node:
                                                                        *mut CustomScanState,
                                                                    estate:
                                                                        *mut EState,
                                                                    eflags:
                                                                        ::std::os::raw::c_int)>,
    pub ExecCustomScan: ::std::option::Option<unsafe extern "C" fn(node:
                                                                       *mut CustomScanState)
                                                  -> *mut TupleTableSlot>,
    pub EndCustomScan: ::std::option::Option<unsafe extern "C" fn(node:
                                                                      *mut CustomScanState)>,
    pub ReScanCustomScan: ::std::option::Option<unsafe extern "C" fn(node:
                                                                         *mut CustomScanState)>,
    pub MarkPosCustomScan: ::std::option::Option<unsafe extern "C" fn(node:
                                                                          *mut CustomScanState)>,
    pub RestrPosCustomScan: ::std::option::Option<unsafe extern "C" fn(node:
                                                                           *mut CustomScanState)>,
    pub ExplainCustomScan: ::std::option::Option<unsafe extern "C" fn(node:
                                                                          *mut CustomScanState,
                                                                      ancestors:
                                                                          *mut List,
                                                                      es:
...
impl ::std::default::Default for CustomExecMethods {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct CustomPathMethods {
    pub CustomName: *const ::std::os::raw::c_char,
    pub PlanCustomPath: ::std::option::Option<unsafe extern "C" fn(root:
                                                                       *mut PlannerInfo,
                                                                   rel:
                                                                       *mut RelOptInfo,
                                                                   best_path:
                                                                   ...
                                                                   custom_plans:
                                                                       *mut List)
                                                  -> *mut Plan>,
    pub TextOutCustomPath: ::std::option::Option<unsafe extern "C" fn(str:
                                                                          StringInfo,
                                                                      node:
                                                                          *const CustomPath)>,
}
impl ::std::default::Default for CustomPathMethods {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
    ...
    pub fn tuplesort_getdatum(state: *mut Tuplesortstate, forward: bool_,
                              val: *mut Datum, isNull: *mut bool_) -> bool_;
    ...
    pub fn make_modifytable(root: *mut PlannerInfo, operation: CmdType,
                            ...
                            resultRelations: *mut List, subplans: *mut List,
